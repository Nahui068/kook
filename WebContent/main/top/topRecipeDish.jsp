...
%>						
    	...
    	<input type="button" class="btn" value = "Main Dish" onClick="location.href='/kook/recipe/list/main_dish.jsp?category=main_dish&pageNum=1'">
    	<input type="button" class="btn" value = "Side Dish" onClick="location.href='/kook/recipe/list/side_dish.jsp?category=side_dish&pageNum=1'">
    	<input type="button" class="btn" value = "Stew & Soup" onClick="location.href='/kook/recipe/list/stew_soup.jsp?category=stew_soup&pageNum=1'">
    	<input type="button" class="btn" value = "Drink" onClick="location.href='/kook/recipe/list/drink.jsp?category=drink&pageNum=1'">
    	<input type="button" class="btn" value = "Dessert" onClick="location.href='/kook/recipe/list/dessert.jsp?category=dessert&pageNum=1'">
    	<input type="button" class="btn" value = "Korean BBQ" onClick="location.href='/kook/recipe/list/korean_bbq.jsp?category=korean_bbq&pageNum=1'">
    	<input type="button" class="btn" value = "Kimchi" onClick="location.href='/kook/recipe/list/kimchi.jsp?category=kimchi&pageNum=1'">
    	<input type="button" class="btn" value = "Etc" onClick="location.href='/kook/recipe/list/etc.jsp?category=etc&pageNum=1'">
