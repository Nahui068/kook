...
%>						
	...
	<input type="button" class="btn" value = "Low" onclick="document.location.href='/kook/recipe/list/low.jsp?difficulty=low&pageNum=1'">
	<input type="button" class="btn" value = "Middle" onclick="document.location.href='/kook/recipe/list/middle.jsp?difficulty=middle&pageNum=1'">
	<input type="button" class="btn" value = "High" onclick="document.location.href='/kook/recipe/list/high.jsp?difficulty=high&pageNum=1'">
