...
<tr>
	...
	<td align = "right" colspan ="4">
		<input type = "button" name = "faqWrite" value="faqWrite" onclick = "window.location = 'faqWriteForm.jsp'" />                    
	</td>
</tr>
<tr >
...
<%
	...
	if (count >0){
		...
		if(startPage>10){%>
			<a href = "faqListAdmin.jsp?pageNum=<%=startPage-10%>">[Previous]</a>
<%		}
		for (int i = startPage; i <=endPage; i++){%>
			<a href ="faqListAdmin.jsp?pageNum=<%=i%>">[<%=i%>]</a>
<%		}
		if(endPage< pageCount) {%>
		<a href="faqListAdmin.jsp?pageNum=<%=startPage +10 %>">[Next]</a>
<%		} 
