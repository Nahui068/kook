...
<%
			...
			if(startPage>5){%>
				<a href="/kook/recipe/recipe.jsp?pageNum=<%= startPage - 5 %>">[이전]</a>
<%
			}
			for (int i = startPage ; i <= endPage ; i++) {
%>
	        	<a href="/kook/recipe/recipe.jsp?pageNum=<%= i %>">[<%= i %>]</a>
<%
	        }
	        if (endPage < pageCount) {  %>
	        	<a href="/kook/recipe/recipe.jsp?pageNum=<%= startPage + 5 %>">[다음]</a>
<%
	        }
    	}
